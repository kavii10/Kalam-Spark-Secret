...
def get_detailed_career_description(dream: str) -> dict:
    ...
    career_database = {
        ...
        "ai engineer|artificial intelligence engineer": {
            "overview": "AI engineers design, develop, and deploy production-ready artificial intelligence systems and applications. You will work on integrating large language models (LLMs), building agentic workflows, fine-tuning neural networks, optimizing prompt engineering, and managing ML/AI ops pipelines. This role bridges the gap between AI research and practical, scalable software engineering.",
            "roles": [
                "Develop and integrate generative AI models and LLM APIs",
                "Build agentic frameworks, retrieval-augmented generation (RAG) pipelines, and vector databases",
                "Fine-tune pre-trained models on custom datasets",
                "Deploy AI models as highly scalable microservices",
                "Optimize inference latency and compute resources",
                "Collaborate with backend engineers to integrate intelligent features",
                "Research and test state-of-the-art model architectures"
            ],
            "required_skills": [
                "Python, TypeScript, or C++ programming",
                "Deep learning frameworks (PyTorch, TensorFlow)",
                "Generative AI stack (LangChain, LlamaIndex, OpenAI, Hugging Face)",
                ...
                "API design and cloud services (AWS, Google Cloud)",
                "Software engineering principles and version control"
            ],
            "market_outlook": "Explosive demand globally. AI adoption is the number one priority for technology, finance, healthcare, and enterprise sectors. High premium on engineers who can transition AI research into production products.",
            "salary_range": "₹10,00,000 - ₹80,00,000+ per year. Entry-level: ₹10-20 LPA, Mid-level: ₹25-50 LPA, Senior: ₹50+ LPA",
            "growth": "Progress to AI Architect, Principal AI Engineer, Director of AI, or VP of Engineering. Strong opportunities to lead AI startup ventures.",
            "tips": "Build real projects using RAG, LLMs, and agentic networks. Contribute to open-source AI frameworks. Master model deployment (MLOps) and stay updated with daily changes in the open-source model community."
        },
